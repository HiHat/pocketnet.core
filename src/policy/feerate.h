...
enum class FeeEstimateMode {
    ...
    POC_KVB,      //!< Use POC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from POC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::POC_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  POCKETCOIN_POLICY_FEERATE_H
