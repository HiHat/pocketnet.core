...
#ifndef POCKETCOIN_PUBKEY_H
#define POCKETCOIN_PUBKEY_H
...
// Convert ecdsa_signature to der format
void ConvertToDER(std::vector<unsigned char>& signature, std::vector<unsigned char>& der_signature);

#endif // POCKETCOIN_PUBKEY_H
