...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, PocketcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &PocketcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &PocketcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &PocketcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &PocketcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &PocketcoinGUI::updateWalletStatus);
    connect(gui, &PocketcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
